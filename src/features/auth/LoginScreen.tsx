...
/** 로그인 — 매직링크(패스워드리스) + Google + Facebook. 일반 id/pw 없음. */
        ...
        <div className="login__card">
          {!sent ? (
            <>
              ...
              />
              <button className="btn btn--primary login__btn" disabled={!valid}
            ...
            <div className="login__sent">
              ...
              <button className="btn btn--primary login__btn" onClick={onLogin}>확인 (데모 로그인)</button>
          ...
          {!sent && (
            <div className="login__socials">
              <button className="sbtn" onClick={onLogin}>
